...
export function coreSource(client) {
  ...
  function load(file) {
    ...
    const require = specifier => {
      ...
      if (['zod', 'react'].includes(specifier)) return nativeRequire(specifier);
    ...
    vm.runInNewContext(compiled, { module: loaded, exports: loaded.exports, require, console, Date, URL, Buffer, setTimeout }, { filename: file });
